...
class SubjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Subject entity")
        ...
        .repeat(2) {
            ...
            .post("/api/subjects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "subject":"SAMPLE_TEXT", "second_name":"SAMPLE_TEXT", "desc":"SAMPLE_TEXT", "home_banner":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "position":"0", "share_image":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
